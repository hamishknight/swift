...
// CHECK1-NEXT: SYSTEM
// CHECK1-NEXT: <Declaration>@actorSafe(unchecked) struct Int : <Type usr="s:s17FixedWidthIntegerP">FixedWidthInteger</Type>{{.*}}<Type usr="s:SZ">SignedInteger</Type>{{.*}}</Declaration>
