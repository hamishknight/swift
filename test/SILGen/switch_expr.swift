...
// CHECK-LABEL: sil hidden [ossa] @$s11switch_expr15testFallthroughSiyF : $@convention(thin) () -> Int
// CHECK:       [[RESULT_STORAGE:%[0-9]+]] = alloc_stack $Int
// CHECK:       [[RESULT:%[0-9]+]] = mark_uninitialized [var] [[RESULT_STORAGE]] : $*Int
// CHECK:       switch_value {{%[0-9]+}} : $Builtin.Int1, case {{%[0-9]+}}: [[TRUEBB:bb[0-9]+]], case {{%[0-9]+}}: [[FALSEBB:bb[0-9]+]]
//
...
//
// CHECK:       [[IFFALSEBB]]:
// CHECK:       [[ZERO_BUILTIN:%[0-9]+]] = integer_literal $Builtin.IntLiteral, 0
// CHECK:       [[ZERO:%[0-9]+]] = apply {{%[0-9]+}}([[ZERO_BUILTIN]], {{%[0-9]+}}) : $@convention(method) (Builtin.IntLiteral, @thin Int.Type) -> Int
// CHECK:       br [[EXITBB:bb[0-9]+]]([[ZERO]] : $Int)
//
// CHECK:       [[FALSEBB]]:
...
// CHECK:       [[VAL:%[0-9]+]] = load [trivial] [[RESULT]] : $*Int
// CHECK:       dealloc_stack [[RESULT_STORAGE]] : $*Int
// CHECK:       br [[EXITBB]]([[VAL]] : $Int)
//
// CHECK:       [[EXITBB]]([[VAL:%[0-9]+]] : $Int):
// CHECK:       return [[VAL]] : $Int
