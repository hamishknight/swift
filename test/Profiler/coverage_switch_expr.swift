...
// CHECK-LABEL: sil_coverage_map {{.*}} "$s20coverage_switch_expr0b1_C12_with_returnySiSbF"
func switch_expr_with_return(_ b: Bool) -> Int { // CHECK-NEXT: [[@LINE]]:48 -> {{[0-9]+}}:2 : 0
  switch b {                                     // CHECK-NEXT: [[@LINE]]:10 -> [[@LINE]]:11 : 0
  case true:                                     // CHECK-NEXT: [[@LINE]]:3 -> [[@LINE+1]]:13 : 1
    return 0
  case false:                                    // CHECK-NEXT: [[@LINE]]:3 -> [[@LINE+1]]:6 : 2
    1                                            // FIXME: The following is incorrect
  }                                              // CHECK-NEXT: [[@LINE]]:4 -> [[@LINE+1]]:2 : 2
}                                                // CHECK-NEXT: }
