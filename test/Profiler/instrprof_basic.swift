...
// CHECK: sil hidden [ossa] [profilable] @[[F_THROWING_NOP:.*throwing_nop.*]] :
func throwing_nop() throws {}
// CHECK: sil hidden [ossa] [profilable] @[[F_EXCEPTIONS:.*exceptions.*]] :
