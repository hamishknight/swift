...
inline const uint8_t *_Nullable BridgedStringRef_data(BridgedStringRef str);
...
inline const uint8_t *_Nullable BridgedOwnedString_data(BridgedOwnedString str);
...
inline bool BridgedSourceLoc_isValid(BridgedSourceLoc str);

SWIFT_NAME("getter:BridgedSourceLoc.raw(self:)")
inline const void *_Nullable BridgedSourceLoc_raw(BridgedSourceLoc str);
