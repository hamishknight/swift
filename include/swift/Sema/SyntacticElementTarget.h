...
public:
  ...
  SyntacticElementTarget(CaseLabelItem *caseLabelItem, Type subjectTy,
                         DeclContext *dc) {
    kind = Kind::caseLabelItem;
    this->caseLabelItem.caseLabelItem = caseLabelItem;
    this->caseLabelItem.subjectTy = subjectTy;
  ...
  static SyntacticElementTarget forCaseLabelItem(CaseLabelItem *caseLabelItem,
                                                 Type subjectTy,
                                                 DeclContext *dc) {
    return {caseLabelItem, subjectTy, dc};
  }
  ...
  Type getCaseLabelItemSubjectType() const {
    assert(kind == Kind::caseLabelItem);
    return caseLabelItem.subjectTy;
  }
