...
class YieldStmt final : public Stmt {
  ...
  YieldStmt(SourceLoc yieldLoc, ArgumentList *args, bool isImplicit);

public:
  static YieldStmt *createParsed(const ASTContext &ctx, SourceLoc yieldLoc,
                                 ArgumentList *args);

  static YieldStmt *createImplicit(const ASTContext &ctx, SourceLoc yieldLoc,
                                   ArgumentList *args);
