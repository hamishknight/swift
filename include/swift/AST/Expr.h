...
public:
  ...
  /// Retrieve the argument list of the subscript expression.
  ArgumentList *getArgs() const { return ArgList; }
  void setArgs(ArgumentList *newArgs) { ArgList = newArgs; }
...
class PrefixUnaryExpr : public ApplyExpr {
  PrefixUnaryExpr(Expr *fn, ArgumentList *argList, Type ty = Type())
    ...
    assert(argList->isUnlabelledUnary());
  }
...
public:
  ...
  Expr *getOperand() const { return getArgs()->get(0).getExpr(); }
  void setOperand(Expr *E) { getArgs()->get(0).setExpr(E); }
...
public:
  Expr *getBase() const { return getArgs()->get(0).getExpr(); }
  void setBase(Expr *E) { getArgs()->get(0).setExpr(E); }
...
public:
  ...
  public:
    ...
    static Component forProperty(ConcreteDeclRef property, Type propertyType,
                                 SourceLoc loc) {
